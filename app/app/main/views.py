...
def contact():
    ...
    try:
        """client = boto3.client('route53', aws_access_key_id='AKIAIFKTY2BD457689BA', aws_secret_access_key='uivab8RLcE92lJdZmjph5XAZayASaC8aOMV3qbb/')

        resourceRecordSet = {'Name': 'www.jeffsonlinebooks.com.',
                             'Type': 'A',
                             'AliasTarget': {'HostedZoneId': 'Z1H1FL5HABSF5',
                                             'DNSName': 'dualstack.af6849add6bc28adaa2e-783865294.us-west-2.elb.amazonaws.com.',
        ...
        client.change_resource_record_sets(HostedZoneId='Z3425', ChangeBatch=changes)"""
        print("test")
